...
2. **Message Body (HTML):**
   ...
   <p><a href="{{ .SiteURL }}/email-confirmation?token={{ .Token }}&type=signup">Confirm Email Address</a></p>
   
   <p>Or copy and paste this link into your browser:</p>
   <p>{{ .SiteURL }}/email-confirmation?token={{ .Token }}&type=signup</p>
...
- `{{ .Token }}` - Email confirmation token generated by Supabase
...
2. **Message Body (HTML):**
   ...
   <p><a href="{{ .SiteURL }}/auth/callback?token={{ .Token }}&type=magiclink">Sign In</a></p>
