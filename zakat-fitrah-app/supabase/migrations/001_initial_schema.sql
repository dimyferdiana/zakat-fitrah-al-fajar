-- ============================================================================
-- Initial Schema for Zakat Fitrah Management System
-- ============================================================================
...
-- Tahun Zakat table
CREATE TABLE public.tahun_zakat (
...
CREATE TABLE public.kategori_mustahik (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
...
CREATE TABLE public.pembayaran_zakat (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
...
-- Tahun Zakat indexes
CREATE INDEX idx_tahun_zakat_is_active ON public.tahun_zakat(is_active);
CREATE INDEX idx_tahun_zakat_tahun_masehi ON public.tahun_zakat(tahun_masehi);

-- Muzakki indexes
CREATE INDEX idx_muzakki_nama_kk ON public.muzakki(nama_kk);
CREATE INDEX idx_muzakki_created_at ON public.muzakki(created_at DESC);

-- Pembayaran Zakat indexes
CREATE INDEX idx_pembayaran_muzakki_id ON public.pembayaran_zakat(muzakki_id);
CREATE INDEX idx_pembayaran_tahun_zakat_id ON public.pembayaran_zakat(tahun_zakat_id);
CREATE INDEX idx_pembayaran_tanggal_bayar ON public.pembayaran_zakat(tanggal_bayar DESC);
CREATE INDEX idx_pembayaran_created_by ON public.pembayaran_zakat(created_by);
CREATE INDEX idx_pembayaran_jenis_zakat ON public.pembayaran_zakat(jenis_zakat);

-- Mustahik indexes
CREATE INDEX idx_mustahik_kategori_id ON public.mustahik(kategori_id);
CREATE INDEX idx_mustahik_nama ON public.mustahik(nama);
CREATE INDEX idx_mustahik_is_active ON public.mustahik(is_active);

-- Distribusi Zakat indexes
CREATE INDEX idx_distribusi_mustahik_id ON public.distribusi_zakat(mustahik_id);
CREATE INDEX idx_distribusi_tahun_zakat_id ON public.distribusi_zakat(tahun_zakat_id);
CREATE INDEX idx_distribusi_tanggal ON public.distribusi_zakat(tanggal_distribusi DESC);
CREATE INDEX idx_distribusi_status ON public.distribusi_zakat(status);
CREATE INDEX idx_distribusi_created_by ON public.distribusi_zakat(created_by);
